...
!function () {
    ...
    (function () {
        ...
        var e = document.querySelectorAll('[data-bs-toggle="search"]'), t = document.querySelector(".navbar-search");
        if (null !== t) for (var r = t.querySelector(".navbar-search-field"), a = 0; a < e.length; a++) e[a].addEventListener("click", function (e) {
        ...
        if (0 !== e.length) for (var t = 0; t < e.length; t++) {
            var r = e[t].dataset.format, a = e[t].dataset.blocks, n = e[t].dataset.delimiter,
                a = void 0 !== a ? a.split(" ").map(Number) : "", n = void 0 !== n ? n : " ";
            switch (r) {
                case"card":
        ...
        var r = _objectSpread(_objectSpread({}, r), n), a = tns(r), n = t.closest(".tns-carousel-wrapper"),
            o = n.querySelectorAll(".tns-item"), l = n.querySelector(".tns-carousel-pager");
        if (null != l) {
        ...
        null != u && a.events.on("indexChanged", function () {
            var e = a.getInfo(), e = o[e.index].dataset.carouselLabel;
            u.innerHTML = e
        ...
        if (null !== o) for (var e = 0; e < o.length; e++) !function (e) {
            function t() {
                if (a.checked) {
            ...
            var r = o[e].querySelector(".form-switch"), a = r.querySelector('input[type="checkbox"]'),
        ...
        if (o.length) for (var e = 0; e < o.length; e++) !function (r) {
        ...
        if (0 !== e.length) for (var t = 0; t < e.length; t++) e[t].addEventListener("change", function () {
            var e = document.querySelector(this.dataset.bsTarget), t = this.dataset.checkboxToggleClass;
